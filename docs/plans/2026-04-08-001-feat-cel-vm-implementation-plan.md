...
- **Timestamp/Duration:** Full timestamp arithmetic requires a date library. Implement basic `getFullYear()` etc. via `Date` for MVP; mark timestamp tests as known-deferred.
