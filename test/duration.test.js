...
describe('duration accessor methods', () => {
  ...
  it('2h30m getMinutes', () => assertCel('duration("2h30m").getMinutes()', 30n))
  it('90s getSeconds', () => assertCel('duration("90s").getSeconds()', 30n))
  it('90s getMinutes', () => assertCel('duration("90s").getMinutes()', 1n))
  it('3723s getHours', () => assertCel('duration("3723s").getHours()', 1n))
  it('3723s getMinutes', () => assertCel('duration("3723s").getMinutes()', 2n))
  it('3723s getSeconds', () => assertCel('duration("3723s").getSeconds()', 3n))
