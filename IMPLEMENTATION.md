...
Built-in functions use BUILTIN IDs 0–65 (66 total, including `STRING_FORMAT` at ID 65). Custom functions are assigned IDs starting at **128**, leaving room for future builtins. IDs are assigned sequentially in registration order. Functions and methods share the same ID space.
